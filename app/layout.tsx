...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://flarecross.com" },
  openGraph: {
    type: "website",
    locale: "en_US",
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "FlairCross Consultants — Automation & AI Development" }],
  },
  twitter: {
    ...
    creator: "@flarecross",
    title: "FlairCross — n8n Automation, AI Agents & Workflow Development",
    description: "Custom n8n workflows, AI agents, and voice AI pipelines that eliminate manual work and save 20+ hours/week.",
    images: ["/og-image.png"],
  },
...
const organizationJsonLd = {
  ...
  description: "FlairCross builds custom n8n automation workflows, AI agents, and voice AI pipelines for growing businesses.",
  sameAs: ["https://twitter.com/flarecross", "https://linkedin.com/company/flarecross"],
  contactPoint: { "@type": "ContactPoint", contactType: "customer service", email: "contact@flarecross.com", availableLanguage: "English" },
